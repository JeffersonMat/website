...
class  WhoIam extends React.Component {
  ...
  handleClick() {
    const indicator = document.querySelectorAll('.control li')
              ...
              <div className="slider-who-i-am" href="#one!">
                ...
                <div className="control">
                  <span className="arrow left">
                    <i className="material-icons" onClick={}>keyboard_arrow_left</i>
                  </span>
                  <span className="arrow right">
                    <i className="material-icons" onClick={}>keyboard_arrow_right</i>
                  </span>
                  <ul>
